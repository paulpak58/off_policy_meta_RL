...
@click.option('--num_train_tasks', default=50)
@click.option('--encoder_hidden_size', default=100)
@click.option('--net_size', default=150)
@click.option('--num_steps_per_epoch', default=1000)
@click.option('--num_initial_steps', default=450)
@click.option('--num_steps_prior', default=150)
@click.option('--num_extra_rl_steps_posterior', default=150)
@click.option('--batch_size', default=64)
@click.option('--embedding_batch_size', default=64)
@click.option('--embedding_mini_batch_size', default=64)
@wrap_experiment
